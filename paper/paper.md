...
{#fig:Connect to Azure SQL Database}
...
![Azure Data Warehouse](images/Azure_SQLDW1.jpg)

{#fig:Azure Data Warehouse}
...
{#fig:Modern Data Warehouse using HDInsight}
...
{#fig:HDInsight in an IoT scenario}
